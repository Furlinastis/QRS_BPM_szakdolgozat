...
//__11
//_1:P-hullam
var greetingMsg = "P-hullámok alapos vizsgálata szükséges tachycardiánál, mert könnyen kitakarható."
  greetingMsg += "\n P-hullámok teljes hiánya esetén:"
  greetingMsg += "\n- - nincs pitvari aktivitás, ezért a P-hullámok nem jönnek létre (sinusleállás, sinotrialis blokk. hyperkalaemia)"
  greetingMsg += "\n P-hullámok időnként jelen vannak:"
  greetingMsg += "\n- sinus-csomó működésének leállása, SA-blokk"
  greetingMsg += "\n További vizsgálni való P-hullámok esetén:"
  greetingMsg += "- fordított P-hullám"
  greetingMsg += "- túl magas P-hullám"
  greetingMsg += "- túl széles P-hullám"
  greetingMsg;
//__1
