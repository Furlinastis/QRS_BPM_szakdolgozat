...
//__11
//_1:PitvarfibrillaciaAVblokkal-kezeles
var greetingMsg = "AV-blokk: A kamrák és pitvarok közötti hibás ingerületvezetést atriovertikuláris-blokknak nevezzük. A szív sinus-csomójából induló elektromos ingerület normális esetben a pitvarok és kamrák találkozásánál található különleges szerkezetű szöveti egységen halad át, ezt nevezzük AV-csomónak. AV-blokknak nevezzük, ha a sinus-csomóból induló ingerület nem ér el a kamrákig. I., II., III. fokú AV-blokkokról beszélhetünk."
greetingMsg += "\n\n - Ritmusszabályozó pacemaker beültetése (Egy kis teleppel rendelkező elektromos eszköz, mely a bőr alá ültetve segíti a szív természetes ingerképzését.)"
greetingMsg += "\n - Beültethető automata defibrillátor (A ritmusszabályozó eszközhöz hasonlóan egy beültethető eszköz, mely életveszélyes kamrafibrilláció esetén egy elektromos kisüléssel azonnal újraindítja a szív helyes működését.)"
greetingMsg += "\n - Katéter abláció (A szív hibás ingerületkeltő szakaszának kiégetése, sikeres esetben a szívműködés teljesen helyreállítható.)"
greetingMsg;
//__1
