...
//__11
//_1:EKG_felhelyezes
var greetingMsg = "Az EKG beállítása: "
greetingMsg += "\n\n- EKG készítésnél a készüléket minden esetben kalibrálni kell "
greetingMsg += "\n- papír: milliméterpapír, mely 25mm/s sebességgel halad normális esetben (részletesebb jelsorozat érdekében lehet lassítani)"
greetingMsg += "\n- egy milliméter 0,04 secnek felel meg, tehát 40 ms-nak"
greetingMsg += "\n- egy centiméter, tehát 10 kiskockányi időintervallum 200 ms-nak felel meg"
greetingMsg += "\n - 5 centiméter hosszú szakasz az 1 secundum időintervallum "
greetingMsg += "\n\n Végtagi elvezetések: "
greetingMsg += "\nFelhelyezés: bal kar: sárga, bal láb: zöld, jobb kar: piros, jobb láb:fekete (földelés)"
greetingMsg += "\n Bipoláris elvezetések: két végtagi elvezetés között mért potenciálkülönbség I., II., III. az EKG papíron"
greetingMsg += "\n Unipoláris elvezetések: egy végtagi elvezetésen észlelhető potenciálváltozás a másik két végtag áltak összeköttetésben lévő elektródákhoz viszonyítva (aVL, aVF, aVR jelölés az EKG papíron)"
greetingMsg += "\n\n Mellkasi elvezetések (lásd a képen): "
greetingMsg += "\n V1: a bordaközi sternum jobb szélénél"
greetingMsg += "\n V2: a bordaközi sternum bal szélénél"
greetingMsg += "\n V3: V2 és V4 közé"
greetingMsg += "\n V4: 5. bordaközi medioclavicularis vonalába"
greetingMsg += "\n V5: 6. bordaköz a bal első hónaljvonalban"
greetingMsg += "\n V6: 6. bordaköz a bal hónaljvonal közepénél"
greetingMsg;
//__1
