...
//__11
//_1:Pitvari AVNRT AVRT kez
var greetingMsg = "A kamrából eredő abnormális jelek miatt a szív túlgyorsult ritmusa nem teszi lehetővé, hogy a kamrák hatékonyan töltődjenek és húzódjanak össze, így hosszabb fennállás esetén nem jut elegendő vér a szervezetbe."
greetingMsg += "\n Sürgősségtől függően a beteg kezelésének többféle kezelése lehetséges. Paradoxon, de ARVT esetében az antiarritmiás gyógyszerek ellenjavaltak."
greetingMsg += "\n Gyógyszeres kezelés után, melyben az embóliás vérrögök képződését véralvadásgátlókkal csökkentik, a szívfrekvencia szabálytalanságának függvényében a következő kezelések állnak elő:"
greetingMsg += "\n - gyógyszeres kezelés (AVRT esetében semmiképp nem antiarritmiás gyógyszerekkel)"
greetingMsg += "\n - elektromos kardióvezérlés ( a szív újraindítása ellenőrzött körülmények között)"
greetingMsg += "\n - katéter abláció (a szív hibás ingerületkeltő szakaszának kiégetése)"
greetingMsg;
//__1
